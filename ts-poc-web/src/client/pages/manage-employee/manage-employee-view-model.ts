...
import "./manage-employee-view.scss";
...
@template(require("./manage-employee-view.html"))
@route(Routes.manageEmployees)
@inject("EmployeeService", "NavigationService")
export class ManageEmployeeViewModel extends PageViewModel
{
    ...
    public set employmentStatus(value: EmployeeEmploymentStatus) { this._employmentStatus = value; }
    ...
    public save(): void
    {        
        const savePromise: Promise<any> = this._id ? this._employeeService.updateEmployee(this._id, this._firstName, this._lastName, this._phone, this._email, this._ssn, this._employeeId, this._firingReason) :
            this._employeeService.createEmployee(this._firstName, this._lastName, this._phone, this._email, this._ssn, this._employeeId, this._employmentStatus);

        savePromise.then(() => this._navigationService.navigate(Routes.listEmployees, {})).catch(e => console.log(e));
    }
